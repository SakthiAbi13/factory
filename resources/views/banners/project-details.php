                    ...
                    <!-- <div class="row">
                        <div class="col-lg-9 col-12">
                            <div class="blog-details-left">
                                <div class="blog-part">
                                    <div class="blog-img">
                                        <img src="images/blog/1.jpg" alt="" id="img">
                                    </div>
                                    <div class="blog-info">
                                        <div class="blog-meta">
                                            <span>
                                                <i class="zmdi zmdi-male-alt"></i>
                                                <span id="pname">Rayed Tayeb</span>
                                            </span>
                                            <span>
                                                <i class="zmdi zmdi-calendar-note"></i>
                                                <span id="date">14 October,2016</span>
                                            </span>
                                            <span>
                                                <a href="#">
                                        ...
                                        <h3 id="title">Lorem Ipsum is simply dummy text of the printing</h3>
