(function($) {
    ...
    // $(".pagelink_carousel").find("a").removeClass("active");
    // $(".pagelink_carousel >.item a").filter(function() {
    //     var link = $(this).attr("href");
    //     if (link) {
    //         if (current.indexOf(link) != -1) {
    //             $(this).addClass('active');
    ...
    $(document).click(function(event) {
        if (!$(event.target).closest(".eye_disable, .tips_section").length) {
            $("body").find(".tips_section").removeClass("active_tips");
        }
    });
...
$('.serach_field-area').on('click', function(e) {
    $(this).addClass("full_w-search");
});

$(document).click(function(event) {
    if (!$(event.target).closest(".full_w-search").length) {
        $("body").find(".serach_field-area").removeClass("full_w-search");
    }
});
...
// tips view list 
$(function () {
    $('.tips_pointlist li:nth-child(4)').after('<li class="more_tips"><span>More...</span></li>');
    var moreList2 = $('.tips_pointlist li:nth-child(5)').nextAll('li').hide();
    $(".more_tips").on("click", function () {
